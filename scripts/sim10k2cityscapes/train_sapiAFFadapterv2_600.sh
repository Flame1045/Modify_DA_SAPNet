...
python tools/train_net.py --config-file "configs/sim10k2cityscapes/sapnetiAFFadapter_R_50_C4v2.yaml" --num-gpus 1 \
--setting-token "sim10k2city-sapnet-adapter-600-l${weight_DA}-e${weight_entropy}-d${weight_diversity}" \
