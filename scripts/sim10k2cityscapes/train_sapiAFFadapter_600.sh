source_model_path="pretrained/sim2city-baseline-source-only/.pth"
...
python tools/train_net.py --config-file "configs/sim10k2cityscapes/sapnetiAFFadapter_R_50_C4.yaml" --num-gpus 1 \
