...
weight_MIC_RPN_CLS=1.0
weight_MIC_RPN_LOC=1.0
weight_MIC_CLS=1.0
weight_MIC_BOX_REG=1.0

python tools/train_net.py --config-file "configs/sim10k2cityscapes/sapnet_R_50_C4_MIC_MEDM.yaml" --num-gpus 1 \
--setting-token "sim10k2city-sapnetMIC-l${weight_DA}-e${weight_entropy}-d${weight_diversity}" \
