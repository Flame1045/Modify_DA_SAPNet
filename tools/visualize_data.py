...
dataset_base_dir = Path.cwd() / 'datasets'
# json_file_path = dataset_base_dir/'Cityscapes-coco'/'cityscapes_detect_custom_test3.json' ######
# image_root =  dataset_base_dir/'Cityscapes-coco'/'VOC2007-car-train'/'JPEGImages'
# split = 'val'
# meta_name = 'cityscapes_vis_{}'.format(split)
...
classes = ('car', )
years = 2007
meta_name = 'cityscapes-car-pseudo_{}'.format(split)
...
'''
python3 tools/visualize_data.py --source annotation --config-file /media/ee4012/Disk3/Eric/Modify_DA_SAPNet/configs/Visualize.yaml --output-dir ./tools/new
'''
